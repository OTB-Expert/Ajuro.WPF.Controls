...
namespace Ajuro.WPF.Controls
{
	...
	public class AjuroList : Control
	{
		/// <summary>
		...
		static AjuroList()
		{
			...
			ProjectSelectorProperty = DependencyProperty.Register("ProjectSelector", typeof(StackPanel), typeof(AjuroList), new PropertyMetadata(null));
			ItemsListProperty = DependencyProperty.Register("ItemsList", typeof(ListView), typeof(AjuroList), new PropertyMetadata(null));
		}
